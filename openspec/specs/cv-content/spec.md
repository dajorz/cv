...
## Purpose
Defines content requirements for the Experience section: bullet quality, quantitative signals, action-verb variety, role structure, and bilingual parity. Merged from changes `refresh-experience-content` and `fix-enhancv-ats-feedback`.
